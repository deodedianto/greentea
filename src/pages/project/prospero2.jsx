...
import ProjectGallery from "components/Project-gallery/project-prospero2";
import ProjectDescription from "components/Project-description/project-description";
import ProjectDate from "data/project-prospero2.json";
...
export const Head = () => {
  return (
    <>
      <title>GreenInterior - Prospero Apartment</title>
    </>
  )
}
