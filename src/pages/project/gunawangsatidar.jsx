...
import ProjectGallery from "components/Project-gallery/project-gunawangsatidar";
import ProjectDescription from "components/Project-description/project-description";
import ProjectDate from "data/project-gunawangsa_tidar.json";
...
export const Head = () => {
  return (
    <>
      <title>GreenInterior - Gunawangsa Tidar Apartment</title>
    </>
  )
}
