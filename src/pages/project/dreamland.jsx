...
import ProjectGallery from "components/Project-gallery/project-dreamland";
import ProjectDescription from "components/Project-description/project-description";
import ProjectDate from "data/project-dreamland.json";
...
export const Head = () => {
  return (
    <>
      <title>GreenInterior - Dreamland</title>
    </>
  )
}
