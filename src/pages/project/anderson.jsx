...
import ProjectGallery from "components/Project-gallery/project-anderson";
import ProjectDescription from "components/Project-description/project-description";
import ProjectDate from "data/project-anderson.json";
...
export const Head = () => {
  return (
    <>
      <title>GreenInterior - Anderson Apartment</title>
    </>
  )
}
