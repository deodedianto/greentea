...
import ProjectGallery from "components/Project-gallery/project-pakuwon";
import ProjectDescription from "components/Project-description/project-description";
import ProjectDate from "data/project-pakuwon.json";
...
export const Head = () => {
  return (
    <>
      <title>GreenInterior - Pakuwon</title>
    </>
  )
}
