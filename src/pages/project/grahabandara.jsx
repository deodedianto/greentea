...
import ProjectGallery from "components/Project-gallery/project-grahabandara";
import ProjectDescription from "components/Project-description/project-description";
import ProjectDate from "data/project-grahabandara.json";
...
export const Head = () => {
  return (
    <>
      <title>GreenInterior - Graha Bandara</title>
    </>
  )
}
