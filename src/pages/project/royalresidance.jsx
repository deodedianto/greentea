...
import ProjectGallery from "components/Project-gallery/project-royalresidance";
import ProjectDescription from "components/Project-description/project-description";
import ProjectDate from "data/project-royalresidance.json";
...
export const Head = () => {
  return (
    <>
      <title>GreenInterior - Royal Residance Mansion Apartment</title>
    </>
  )
}
