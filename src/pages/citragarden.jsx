...
import ProjectGallery from "components/Project-gallery/project-citragarden";
import ProjectDescription from "components/Project-description/project-description";
import ProjectDate from "data/project-citragarden.json";
...
export const Head = () => {
  return (
    <>
      <title>GreenInterior - Citra Gargen</title>
    </>
  )
}
