...
import ProjectGallery from "components/Project-gallery/project-bessmansion2";
import ProjectDescription from "components/Project-description/project-description";
import ProjectDate from "data/project-bessmansion2.json";
...
export const Head = () => {
  return (
    <>
      <title>GreenInterior - Bess Mansion Apartment</title>
    </>
  )
}
