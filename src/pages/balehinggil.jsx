...
import ProjectGallery from "components/Project-gallery/project-balehinggil";
import ProjectDescription from "components/Project-description/project-description";
import ProjectDate from "data/project-balehinggil.json";
...
export const Head = () => {
  return (
    <>
      <title>GreenInterior - Bale Hinggil Apartment</title>
    </>
  )
}
